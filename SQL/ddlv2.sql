...
CREATE TABLE Recipe (
    ...
    FOREIGN KEY (National_Cusine_ID) REFERENCES National_Cusine(ID_National_Cusine) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE Recipe_Meal (
    ...
    FOREIGN KEY (ID_Meal) REFERENCES Meal(ID_Meal) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE Recipe_Tag (
    ...
    FOREIGN KEY (ID_Tag) REFERENCES Tags(ID_Tag) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (ID_Recipe) REFERENCES Recipe(ID_Recipe) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE Recipe_Equipment (
    ...
    FOREIGN KEY (ID_Equipment) REFERENCES Equipment(ID_Equipment) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (ID_Recipe) REFERENCES Recipe(ID_Recipe) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE Ingredient (
    ...
    ID_Recipe INT NOT NULL,
    FOREIGN KEY (ID_Food_Category) REFERENCES Food_Category(Code) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (ID_Recipe) REFERENCES Recipe(ID_Recipe) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE Recipe_Thematic_Unit (
    ...
    FOREIGN KEY (ID_Thematic_Unit) REFERENCES Thematic_Unit(ID_Thematic_Unit) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (ID_Recipe) REFERENCES Recipe(ID_Recipe) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE Rating (
	...
	FOREIGN KEY (ID_Episode) REFERENCES Episode(ID_Episode) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (ID_Chef) REFERENCES Chef(ID_Chef) ON DELETE RESTRICT ON UPDATE CASCADE,
    FOREIGN KEY (ID_Judge) REFERENCES Chef(ID_Chef) ON DELETE RESTRICT ON UPDATE CASCADE
);
